            ...
            if (dbUser == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (roleResult.Succeeded)
                    {
                        ...
                        throw new AccommodationException(ErrorMessages.USER_NOT_ADDED_TO_ROLE);
                }
                else
            ...
            if (!isExist)
            {
                ...
                else
                {
                    if (result.Errors != null)
                    {
                        ...
                        {
                            throw new AccommodationException(error.Description);
                        }
                    }
                }
            }
            else
                throw new AccommodationException(ErrorMessages.ROLE_ALREADY_EXIST);
